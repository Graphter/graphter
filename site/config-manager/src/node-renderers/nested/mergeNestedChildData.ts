...
export const mergeNestedChildData:MergeChildDataFn = async (config, path, getNodeValue, childData) => {
  ...
  return nestedRendererReg.mergeChildData ?
    nestedRendererReg.mergeChildData(nestedConfig, path, getNodeValue, childData) :
    null
}