...
export const initialiseNestedData:InitialiseNodeDataFn = (config, path, initialise, originalTreeData) => {
  ...
  nestedRenderer.initialiseData(nestedConfig, transparentPath, initialise, originalTreeData)
}